...
namespace AriyaInfoTech\NewsletterDiscountPro\Ui\Program;
    ...
    \Magento\Ui\DataProvider\AbstractDataProvider
{
    ...
    /**
     * @var \AriyaInfoTech\NewsletterDiscountPro\Model\ResourceModel\Program\Collection
     */
    ...
    public function __construct(
        ...
        $primaryFieldName,
        $requestFieldName,
        \AriyaInfoTech\NewsletterDiscountPro\Model\ResourceModel\Program\Collection $collection,
        array $meta = [],
        array $data = []
    ) {
