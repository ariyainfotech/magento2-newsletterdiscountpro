...
namespace AriyaInfoTech\NewsletterDiscountPro\Model\Total\Quote;
    ...
    \Magento\Quote\Model\Quote\Address\Total\AbstractTotal
{
    ...
    /**
     * @var \AriyaInfoTech\NewsletterDiscountPro\Model\Service
     */
    protected $service;
    ...
    /**
     * @var \AriyaInfoTech\NewsletterDiscountPro\Model\Program
     */
    protected $_program;

    public function __construct(
        \AriyaInfoTech\NewsletterDiscountPro\Helper\Config $helperConfig,
        \AriyaInfoTech\NewsletterDiscountPro\Model\Service $service,
...
//        die();
        ...
        $amount     = 0;
        if ( $discountOn == \AriyaInfoTech\NewsletterDiscountPro\Model\Config\Source\DiscountOn::SUBTOTAL ) {
            $amount = $total->getBaseSubtotal();
        }
        if ( $discountOn == \AriyaInfoTech\NewsletterDiscountPro\Model\Config\Source\DiscountOn::GRANDTOTAL ) {
